      ...
      <div className={style.pageContainer}>
        <div>
          ...
          <div className={style.searchContainer}>
            ...
            <div className={style.productContainer}>{!loading && products?.map((item) => <Product largura={286} altura={286} data={item.data} key={item.uid} itemId={item.uid} button label />)}</div>
          </div>
        </div>
        <Footer />
      </div>
