...
const MyCart = () => {
    ...
    return (
        ...
        <div className="table">
          ...
          {userProducts?.map((item, index) => (
            <div style={{padding:"16px 0px"}}>
              ...
              <span className="removetxt"key={++index} onClick={()=>deleteProduct(item.uid)}
              onTouchStart={()=>deleteProduct(item.uid)}
              >Remove</span>
              <span className="wishlisttxt" key={index}>Move to Wishlist</span>
              </div>
            </div>
          ))}
          </div>
        ...
        <div className="ordersummary">
          ...
          <div style={{ width: "50%", padding: "0px 9px" }}>
          <button className="btnPlace">Place Order</button>
        </div>
        <div style={{ width: "50%", padding: "0px 9px" }}>
