                    ...
                    <div className={`text-dark ${styles.sideMenu}`}>
                            ...
                            >
                                <div className={styles.options}>
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            type="checkbox"
                                            checked={selectedSize === 'Extra Small'}
                                            onChange={() => handleCheckboxSize('Extra Small')}
                                        />
                                        Extra Small
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxSize('Small')}
                                        />
                                        Small
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxSize('Medium')}
                                        />
                                        Medium
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxSize('Large')}
                                        />
                                        Large
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxSize('Extra Large')}
                                        />
                                        Extra Large
                                    </label>
                                </div>
                                ...
                                <div className={styles.options}>
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxColor('Blue')}
                                        />
                                        Blue
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            type="checkbox"
                                            checked={selectedColor === 'Maroon Red'}
                                            onChange={() => handleCheckboxColor('Maroon Red')}
                                        />
                                        Maroon Red
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            type="checkbox"
                                            checked={selectedColor === 'Crimson Red'}
                                            onChange={() => handleCheckboxColor('Crimson Red')}
                                        />
                                        Crimson Red
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            type="checkbox"
                                            checked={selectedColor === 'Seinna Pink'}
                                            onChange={() => handleCheckboxColor('Seinna Pink')}
                                        />
                                        Seinna Pink
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxColor('Teal')}
                                        />
                                        Teal
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            type="checkbox"
                                            checked={selectedColor === 'Aquamarine'}
                                            onChange={() => handleCheckboxColor('Aquamarine')}
                                        />
                                        Aquamarine
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxColor('Off-White')}
                                        />
                                        Off-White
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            type="checkbox"
                                            checked={selectedColor === 'Muave Orange'}
                                            onChange={() => handleCheckboxColor('Muave Orange')}
                                        />
                                        Muave Orange
                                    </label>
                                </div>
                            ...
                            >
                                <div className={styles.options}>
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            type="checkbox"
                                            checked={selectedBrand === 'Zara'}
                                            onChange={() => handleCheckboxBrand('Zara')}
                                        />
                                        Zara
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            type="checkbox"
                                            checked={selectedBrand === 'D&G'}
                                            onChange={() => handleCheckboxBrand('D&G')}
                                        />
                                        D&G
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxBrand('H&M')}
                                        />
                                        H&M
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            type="checkbox"
                                            checked={selectedBrand === 'Chanel'}
                                            onChange={() => handleCheckboxBrand('Chanel')}
                                        />
                                        Chanel
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            type="checkbox"
                                            checked={selectedBrand === 'Prada'}
                                            onChange={() => handleCheckboxBrand('Prada')}
                                        />
                                        Prada
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            type="checkbox"
                                            checked={selectedBrand === 'Biba'}
                                            onChange={() => handleCheckboxBrand('Biba')}
                                        />
                                        Biba
                                    </label>
                                </div>
                                ...
                                <div className={styles.options}>
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxPrice('20')}
                                        />
                                        $0 - 20
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxPrice('40')}
                                        />
                                        $40
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            type="checkbox"
                                            checked={selectedPrice === '60'}
                                            onChange={() => handleCheckboxPrice('60')}
                                        />
                                        $60
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            type="checkbox"
                                            checked={selectedPrice === 'OverPrice'}
                                            onChange={() => handleCheckboxPrice('OverPrice')}
                                        />
                                        $60 +
                                    </label>
                                </div>
                                ...
                                <div className={styles.options}>
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxDiscount('10%')}
                                        />
                                        10%
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxDiscount('20%')}
                                        />
                                        20%
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxDiscount('50%')}
                                        />
                                        50%
                                    </label>
                                </div>
                        ...
                        <div className={styles.menuCategory}>
                            <div className={styles.filterTitle}>
                                ...
                                <button onClick={handleOpenAvailability}>{openAvailability ? (
                                    <PlusSvg plus={false} />
                                ) : (
                                    <PlusSvg plus={true} />
                                )}</button>
                            ...
                            <div
                                className={`${styles.filterContent} ${openAvailability && styles.show}`}
                                ref={AvailabilityRefHeight}
                                style={{ height: openAvailability ? heightAvailability : '0px' }}
                            >
                                <div className={styles.options}>
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxAvailability('Available')}
                                        />
                                        Available
                                    </label>
                                    ...
                                    <label className='body-medium text-low-emphasis'>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxAvailability('Unavailable')}
                                        />
                                        Unavailable
                                    </label>
                                </div>
