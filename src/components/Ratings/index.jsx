        ...
        <>
            {phone ? (
                <>
                    {reviewData.length === 0 ? (
                        <>
                            <MobileLayout open setOpen={setRatingsOpen} icon={'arrow'} iconAngle={90} iconStroke={'#13101E'} buttons={[{ text: 'Write a Review', btnIcon: <PlusSvg plus stroke={'#fff'} />, onClick: () => handleReviewModalOpen(true) }]}>
                        ...
                        <>
                            <div className={styles.noTasks}>
                                ...
                                <div className={styles.reviewBtn}>
                                    <DefaultBtn icon={<PlusSvg plus stroke={'#fff'} />} onClick={() => handleReviewModalOpen(true)}>Write a Review</DefaultBtn>
                                </div>
                            </div>
