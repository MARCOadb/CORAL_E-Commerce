const ChevronRightSmallsvg = ({ stroke, width, height, rotate, onClick }) => {
    ...
    return (
        ...
        <svg width={width ? width : "24"} height={height ? height : "24"} style={{ transition: '0.25s cubic-bezier(1, 0, 0, 1), height 0.25s cubic-bezier(1, 0, 0, 1)' }} transform={`rotate(${rotate})`} onClick={onClick && onClick} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
