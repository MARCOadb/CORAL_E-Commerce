const ChevronRightSvg = ({ stroke, width, height, onClick, rotate }) => {
    ...
    return (
        ...
        <svg width={width ? width : "24"} height={height ? height : "24"} onClick={onClick && onClick} transform={`rotate(${rotate})`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
